        ...
        <section id="contact" className="relative bg-gray-900 dark:bg-gray-200 pt-11 md:py-20 2xl:py-40 2xl:h-full">
          <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap lg:w-5/6 xl:w-3/4 justify-center">
            ...
            <Fade top>
              ...
              <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-blue-600 sm:text-4xl text-3xl mb-1 font-medium title-font">
                Hire Me
              </h2>
              ...
              <div className="relative mb-4">
                <label htmlFor="email" className="leading-7 text-sm text-gray-400 dark:text-gray-800">
                  Email
                </label>
                <input
                  type="email"
          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-900 dark:bg-gray-200 rounded-lg overflow-hidden sm:ml-10 p-10 flex items-end justify-start relative">
              ...
              <div className="bg-gray-900 dark:bg-gray-200 relative flex flex-wrap py-4 rounded shadow-lg">
                ...
                <div className="lg:w-1/2 px-2 md:px-6 mt-4 lg:mt-0">
                  ...
                  <a href='mailto:benjaminpeto23@gmail.com' className="text-blue-500 leading-relaxed">
