                ...
                <div className='flex flex-row h-screen'>
                    <div className='flex flex-col w-9/12 bg-gray-900 dark:bg-gray-200 justify-center align-middle mx-auto px-6 md:px-28 lg:px-48 xl:px-64 2xl:px-96'>
                        <Slide left>
                            ...
                            <h2 className='text-green-400 font-mono font-bold pt-0 md:pt-2 text-base md:text-xl'>Full-stack Developer,  <span className='text-blue-500 font-thin'>with a lean towards Front-end</span></h2>
                            <div className='pt-8'>
